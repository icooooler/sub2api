...
// is immediately before native_compaction_v2; input_content is the final field.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// input_content is last; created_at is penultimate; native_compaction_v2 and
	// session_id precede them.
	...
	require.Equal(t, "text", usageLogInsertArgTypes[len(usageLogInsertArgTypes)-1],
		"input_content arg type must be text")
}
