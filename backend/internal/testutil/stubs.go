...
func (c StubGatewayCache) GetStickyAutoRouteGroupID(_ context.Context, _ int64, _ string, _ string) (int64, error) {
	return 0, nil
}
func (c StubGatewayCache) SetStickyAutoRouteGroupID(_ context.Context, _ int64, _ string, _ string, _ int64, _ time.Duration) error {
	return nil
}
func (c StubGatewayCache) DeleteStickyAutoRouteGroupID(_ context.Context, _ int64, _ string, _ string) error {
	return nil
}
